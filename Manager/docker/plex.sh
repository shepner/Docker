...
#   `sudo tar -cf /mnt/nas/docker1/plex/config/plex.tar Library`
#   `sudo mv /var/lib/plexmediaserver /var/lib/plexmediaserver.orig`
#
#   `sudo ln -s /mnt/nas/docker1/plex/config /var/lib/plexmediaserver`
#   `sudo ln -s /mnt/nas/docker1/plex/transcode /transcode`
#   `sudo ln -s /mnt/nas/media /data`
